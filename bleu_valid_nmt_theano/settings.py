...
class TranslationSettings(BaseSettings):
    ...
    def _add_console_arguments(self):
        ...
        self._parser.add_argument('--source_dic', type=str, default=None)
        self._parser.add_argument('--target_dic', type=str, default=None)
        self._parser.add_argument('--options', type = str, default = None)
