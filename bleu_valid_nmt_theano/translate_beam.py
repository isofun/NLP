...
from nmt import (build_beam_sampler, build_sampler)
from theano_util import (numpy_floatX, load_params, init_theano_params)
from util import load_dict, load_config
from batch_beam_search import _mask_probs, _tensor_gather_helper, process_beam_results, process_beam_results2
...
def main(model, dictionary, dictionary_target, source_file, saveto, k=5, batch_size = 16, opt_base=None,
    ...
    for batch in batches:
        final_word_ids, final_beam_ids, final_beam_scores = f_beam_sample(*batch)
